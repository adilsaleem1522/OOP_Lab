public class ProductDemo {
	...
	if(p7.equals(p8))
		System.out.println("names of p7 and p8 are equal");
	else
		System.out.println("names of p7 and p8 are not equal");

	if(p7.getExpireyDate().equals(p8.getExpireyDate()))
		System.out.println("dates of p7 and p8 are equal");
	else 
		System.out.println("dates of p7 and p8 are not equal");
